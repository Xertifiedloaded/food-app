...
const Modal = () => {
    ...
    const { cartItems, AddToCart, removeFromCart, toggleModal } = useContext(userContext)
    const itemsPrice = cartItems.reduce((a, c) => a + c.price * c.qty, 0)
    const BankCharges = itemsPrice * 0.14;
    const Delivery = itemsPrice > 2000 ? 0 : 50
            ...
            <div className={classes.main}>
                <div className={classes.modalContainer}>
                    ...
                    <div>
                        {
                            cartItems.map((items) => (
                                <ModalCart AddToCart={AddToCart} removeFromCart={removeFromCart} items={items} key={items.id} />
                            ))
                        }
                        ...
                        cartItems.length !== 0 && (
                            <div className={classes.amount}>
                                ...
                                <div className={classes.totalPrice}>
                                    ...
                                    <p className={classes.totalAmt}> ${totalPrice.toFixed(2)}</p>
                                </div>
